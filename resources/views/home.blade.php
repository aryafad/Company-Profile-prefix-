                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                ...
                                <div class="ml-auto mt-md-3 mt-lg-0">
                                   ...
                                   <div class="row mt-4">
                                       <div class="col-7 align-self-center">
                                           <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">View Contact</h4>
                                           <div class="d-flex align-items-center">
                                               <nav aria-label="breadcrumb">
                                                   <ol class="breadcrumb m-0 p-0">
                                       ...
                                       <div class="col-5 align-self-center">
                                           <div class="customize-input float-right">
                                              <a href="{{url('add-contact')}}"
                                               class="btn waves-effect waves-light btn-rounded btn-primary">Add Contact</a>
                                           </div>
                                       </div>
                                                       ...
                                                       <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                                           ...
                                                           <tbody>
                                                               ...
                                                               <tr>
                                                                   ...
                                                                   <td>{{$view -> subject}}</td>
                                                                   <td>{{$view -> pesan}}</td>
                                                                   <td> <a href="{{url('/edit-contact/'.$view->id)}}"
                                                                           class="btn waves-effect waves-light btn-rounded btn-warning">Edit</a>
                                                                       <a href="{{url('/delete-contact/'.$view->id)}}"
                                                                           class="btn waves-effect waves-light btn-rounded btn-danger" onclick="return confirm('Yakin untuk menghapus data ?')">Delete</a></td>
                                                               </tr>
                                                              @endforeach
                                                           </tbody>
                                                       </table>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="border-top-0 px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                src="package/assets/images/users/widget-table-pic1.jpg"
                                            ...
                                            <tr>
                                                <td class="px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                src="package/assets/images/users/widget-table-pic2.jpg"
                                                                alt="user" class="rounded-circle" width="45"
                                                                height="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td class="px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                src="package/assets/images/users/widget-table-pic3.jpg"
                                                                alt="user" class="rounded-circle" width="45"
                                                                height="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td class="px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                src="package/assets/images/users/widget-table-pic4.jpg"
                                                                alt="user" class="rounded-circle" width="45"
                                                                height="45" /></div>
                                                        <div class="">
