...
<head>
    ...
    <!-- Custom CSS -->
    <link href="{{asset('package/assets/extra-libs/c3/c3.min.css')}}" rel="stylesheet">
    <link href="{{asset('package/assets/libs/chartist/dist/chartist.min.css')}}" rel="stylesheet">
    <link href="{{asset('package/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.css')}}" rel="stylesheet" />
    <!-- Custom CSS -->
    <link href="{{asset('package/dist/css/style.min.css')}}" rel="stylesheet">
...
<body>
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index.html">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="{{asset('package/assets/images/logo-icon.png')}}" alt="homepage" class="dark-logo" />
                                <!-- Light Logo icon -->
                                <img src="{{asset('package/assets/images/logo-icon.png')}}" alt="homepage" class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="{{asset('package/assets/images/logo-text.png')}}" alt="homepage" class="dark-logo" />
                                <!-- Light Logo text -->
                                <img src="{{asset('package/assets/images/logo-light-text.png')}}" class="light-logo" alt="homepage" />
                            </span>
                        </a>
                    </div>
                    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <img src="{{ asset('package/assets/images/users/profile-pic.jpg') }}" alt="user" class="rounded-circle"
                                    width="40">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{ url('/blogs') }}"
                                aria-expanded="false"><i data-feather="sidebar" class="feather-icon"></i><span
                                    class="hide-menu">Blog
                                </span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{ url('/pricings') }}"
                                aria-expanded="false"><i data-feather="sidebar" class="feather-icon"></i><span
                                    class="hide-menu">Pricing
                                </span></a>
                        </li>
                         <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="{{('javascript:void(0)')}}"
                                aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="{{url('/slider')}}" class="sidebar-link"><span
                                            class="hide-menu">  Slider
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="{{url('/about')}}" class="sidebar-link"><span
                                            class="hide-menu">  About
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="{{url('/service')}}" class="sidebar-link"><span
                                            class="hide-menu">  Services
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="{{url('/portofolio')}}" class="sidebar-link"><span
                                            class="hide-menu">  Portfolio
                                        </span></a>
                                </li>
                            </ul>
                        </li>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="{{asset('package/assets/libs/jquery/dist/jquery.min.js')}}"></script>
    <script src="{{asset('package/assets/libs/popper.js/dist/umd/popper.min.js')}}"></script>
    <script src="{{asset('package/assets/libs/bootstrap/dist/js/bootstrap.min.js')}}"></script>
    <!-- apps -->
    <!-- apps -->
    <script src="{{asset('package/dist/js/app-style-switcher.js')}}"></script>
    <script src="{{asset('package/dist/js/feather.min.js')}}"></script>
    <script src="{{asset('package/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js')}}"></script>
    <script src="{{asset('package/dist/js/sidebarmenu.js')}}"></script>
    <!--Custom JavaScript -->
    <script src="{{asset('package/dist/js/custom.min.js')}}"></script>
    <script src="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote.min.js"></script>
    <!--This page JavaScript -->
    <script src="{{asset('package/assets/extra-libs/c3/d3.min.js')}}"></script>
    <script src="{{asset('package/assets/extra-libs/c3/c3.min.js')}}"></script>
    <script src="{{asset('package/assets/libs/chartist/dist/chartist.min.js')}}"></script>
    <script src="{{asset('package/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js')}}"></script>
    <script src="{{asset('package/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.min.js')}}"></script>
    <script src="{{asset('package/assets/extra-libs/jvector/jquery-jvectormap-world-mill-en.js')}}"></script>
    <script src="{{asset('package/dist/js/pages/dashboards/dashboard1.min.js')}}"></script>
    <script>
