            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">View Pricing</h4>
                    ...
                    <div class="col-5 align-self-center">
                        <div class="customize-input float-right">
                           <a href="{{url('add-pricing')}}"
                            class="btn waves-effect waves-light btn-rounded btn-primary">Add Pricing</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">View Pricing</h4>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <a href="{{url('/edit-pricing/'.$view->id)}}"
                                                        class="btn waves-effect waves-light btn-rounded btn-warning">Edit</a>
                                                    <a href="{{url('/delete-pricing/'.$view->id)}}"
