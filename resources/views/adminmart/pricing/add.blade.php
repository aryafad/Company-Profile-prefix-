            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Add Pricing</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Home</a></li>
                                     <li class="breadcrumb-item text-muted active" aria-current="page">Pricing</li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Add Pricing</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Masukkan data Pricing</h6>
                                <form class="mt-4" method="post" action="{{url('tambah-pricing')}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="harga" style="border-radius: 50px ;"> </textarea> 
                                    </div>
                                    <div class="form-group">
                                    	<label style="margin-left: 10px">Deskripsi</label>
                                        <textarea class="form-control" id="summernote" name="deskripsi" rows="3" style="border-radius: 10px ;"></textarea>
                                    </div>
                                    <form class="mt-3">
                                      <div align="center">
