            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Add About</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Home</a></li>
                                     <li class="breadcrumb-item text-muted active" aria-current="page">About</li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Add About</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Masukkan data about</h6>
                                <form class="mt-4" method="post" action="{{url('tambah-blogs')}}" enctype="multipart/form-data">
                                    @csrf
